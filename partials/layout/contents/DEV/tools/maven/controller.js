...
define(['projectWeb'], function () {
	...
	var mavenModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'mavenService', 'devLayoutService']);
	
	mavenModule.controller('mavenController', ['$scope', '$ocLazyLoad', 'mavenService', 'devLayoutService',
	                                      	        function($scope, $ocLazyLoad, mavenService, devLayoutService) {
