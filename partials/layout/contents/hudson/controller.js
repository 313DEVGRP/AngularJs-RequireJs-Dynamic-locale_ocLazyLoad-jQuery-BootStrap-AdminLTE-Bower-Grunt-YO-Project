...
define(['projectWeb'], function () {
	...
	var hudsonModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'hudsonService', 'layoutService']);
	
	hudsonModule.controller('hudsonController', ['$scope', '$ocLazyLoad', 'hudsonService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, hudsonService, layoutService) {
