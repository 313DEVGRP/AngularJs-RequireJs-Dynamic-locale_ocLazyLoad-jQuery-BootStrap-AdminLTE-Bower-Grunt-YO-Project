...
define(
		...
		function() {
			...
			var machineLearningModule = angular.module('projectWeb', [
					'ui.router', 'oc.lazyLoad', 'machineLearningService',
					'devLayoutService'
			]);

			machineLearningModule.controller('machineLearningHeaderController',
					[
							'$scope',
							'$rootScope',
							'$ocLazyLoad',
							...
							function($scope, $rootScope, $ocLazyLoad,
									machineLearningService, devLayoutService) {
					...
					]);// machineLearningHeaderController.controller
