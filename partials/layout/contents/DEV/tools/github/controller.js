...
define(['projectWeb'], function () {
	...
	var githubModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'githubService', 'devLayoutService']);
	
	githubModule.controller('githubController', ['$scope', '$ocLazyLoad', 'githubService', 'devLayoutService',
	                                      	        function($scope, $ocLazyLoad, githubService, devLayoutService) {
