...
define(['projectWeb'], function () {
	...
	var fisheyeCrucibleModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'fisheyeCrucibleService', 'layoutService']);
	
	fisheyeCrucibleModule.controller('fisheyeCrucibleController', ['$scope', '$ocLazyLoad', 'fisheyeCrucibleService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, fisheyeCrucibleService, layoutService) {
