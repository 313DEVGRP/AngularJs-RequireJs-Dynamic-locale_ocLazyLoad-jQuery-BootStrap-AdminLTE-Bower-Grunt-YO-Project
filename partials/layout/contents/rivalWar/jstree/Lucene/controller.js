...
define(
		...
		function() {
			...
			var luceneModule = angular.module('projectWeb', ['ui.router',
					'oc.lazyLoad', 'luceneService', 'devLayoutService'
			]);

			luceneModule.controller('luceneHeaderController', [
					'$scope',
					'$rootScope',
					'$ocLazyLoad',
					'luceneService',
					'devLayoutService',
					function($scope, $rootScope, $ocLazyLoad, luceneService,
							devLayoutService) {
			...
			]);// luceneHeaderController.controller
					...
					.controller(
							...
							[
									...
									function($scope, $ocLazyLoad,
											luceneService, devLayoutService) {
