...
define(['projectWeb'], function () {
	...
	var nexusModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'nexusService', 'devLayoutService']);
	
	nexusModule.controller('nexusController', ['$scope', '$ocLazyLoad', 'nexusService', 'devLayoutService',
	                                      	        function($scope, $ocLazyLoad, nexusService, devLayoutService) {
