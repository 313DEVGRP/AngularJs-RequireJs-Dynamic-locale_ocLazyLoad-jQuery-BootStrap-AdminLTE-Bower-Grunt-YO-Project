...
define(['projectWeb'], function () {
	...
	var nexusModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'nexusService', 'layoutService']);
	
	nexusModule.controller('nexusController', ['$scope', '$ocLazyLoad', 'nexusService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, nexusService, layoutService) {
