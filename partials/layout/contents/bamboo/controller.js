...
define(['projectWeb'], function () {
	...
	var bambooModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'bambooService', 'layoutService']);
	
	bambooModule.controller('bambooController', ['$scope', '$ocLazyLoad', 'bambooService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, bambooService, layoutService) {
