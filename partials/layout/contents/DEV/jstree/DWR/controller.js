...
define(
		...
		function() {
			...
			var dwrModule = angular.module('projectWeb', ['ui.router',
					'oc.lazyLoad', 'dwrService', 'devLayoutService'
			]);

			dwrModule.controller('dwrHeaderController', [
					'$scope',
					'$rootScope',
					'$ocLazyLoad',
					'dwrService',
					'devLayoutService',
					function($scope, $rootScope, $ocLazyLoad, dwrService,
							devLayoutService) {
			...
			]);// dwrHeaderController.controller
