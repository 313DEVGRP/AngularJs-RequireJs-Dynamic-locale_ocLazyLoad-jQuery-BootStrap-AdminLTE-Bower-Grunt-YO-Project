...
define(
		...
		function() {
			...
			var springMyBatisModule = angular.module('projectWeb', [
					'ui.router', 'oc.lazyLoad', 'springMyBatisService',
					'devLayoutService'
			]);

			springMyBatisModule.controller('springMyBatisHeaderController', [
					'$scope',
					'$rootScope',
					'$ocLazyLoad',
					'springMyBatisService',
					'devLayoutService',
					function($scope, $rootScope, $ocLazyLoad,
							springMyBatisService, devLayoutService) {
			...
			]);// springMyBatisHeaderController.controller
