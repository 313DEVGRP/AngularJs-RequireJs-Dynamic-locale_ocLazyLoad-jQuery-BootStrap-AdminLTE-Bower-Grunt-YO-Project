...
define(['projectWeb'], function () {
	...
	var luceneModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'luceneService', 'layoutService']);
	
	luceneModule.controller('luceneController', ['$scope', '$ocLazyLoad', 'luceneService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, luceneService, layoutService) {
