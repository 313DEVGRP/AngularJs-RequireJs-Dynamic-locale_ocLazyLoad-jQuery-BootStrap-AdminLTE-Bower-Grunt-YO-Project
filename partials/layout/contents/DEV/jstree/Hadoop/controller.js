...
define(['projectWeb'], function () {
	...
	var hadoopModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'hadoopService', 'devLayoutService']);
	
	hadoopModule.controller('hadoopController', ['$scope', '$ocLazyLoad', 'hadoopService', 'devLayoutService',
	                                      	        function($scope, $ocLazyLoad, hadoopService, devLayoutService) {
