...
define(['projectWeb'], function () {
	...
	var backendDevelopersModule = angular.module('projectWeb', ['ui.router', 'oc.lazyLoad', 'backendDevelopersService', 'layoutService']);
	
	backendDevelopersModule.controller('backendDevelopersController', ['$scope', '$ocLazyLoad', 'backendDevelopersService', 'layoutService',
	                                      	        function($scope, $ocLazyLoad, backendDevelopersService, layoutService) {
